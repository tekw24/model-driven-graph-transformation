 ...
 *
 */
public class ColumnOptionsRendererService implements EMFFormsDIRendererService<VControl> {
	...
	public double isApplicable(VElement vElement, ViewModelContext viewModelContext) {
		...
		if (MigrationPackage.eINSTANCE.getPartiallyResolvable_ResolveOptions().equals(eStructuralFeature)) {
			return 10;
		}

		if (MigrationPackage.eINSTANCE.getNotAutomaticallyResolvable_ResolveOptions().equals(eStructuralFeature)) {
			return 10;
		}
		return NOT_APPLICABLE;
	...
	public Class<? extends AbstractSWTRenderer<VControl>> getRendererClass() {
		return ColumnOptionsRenderer.class;
	}
