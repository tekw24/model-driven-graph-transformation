 ...
 */
package de.thm.evolvedb.graph.handler;
...
import de.thm.evolvedb.graph.difference.wizard.DifferenceType;
import de.thm.evolvedb.graph.difference.wizard.GraphDifferenceBuilderWizard;
import de.thm.mdde.commonui.exception.handler.ErrorHandler;
import de.thm.mdde.commonui.model.validation.ModelValidation;


public class GraphLiftedDifferenceBuilderHandler extends AbstractHandler {
		...
		if (result) {
			...
			Display.getDefault().asyncExec(() -> {
				...
				WizardDialog wd = new WizardDialog(UIUtil.getActiveShell(),
						new GraphDifferenceBuilderWizard(inputModels, DifferenceType.LIFTEDDIFFERENCE));
