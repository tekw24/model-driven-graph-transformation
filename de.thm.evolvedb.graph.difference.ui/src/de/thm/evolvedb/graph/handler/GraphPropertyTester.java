...
public class GraphPropertyTester extends PropertyTester {

	private static final String MODEL_FILE = "graphFile";
	...
	public boolean test(Object receiver, String property, Object[] args, Object expectedValue) {
		if(property.equals(MODEL_FILE)){
			if(receiver instanceof IFile) {
				...
				if(documentType.size() == 1 && documentType.contains("http://www.thm.de/graph"))
					return true;				
			}
		}
		return false;
