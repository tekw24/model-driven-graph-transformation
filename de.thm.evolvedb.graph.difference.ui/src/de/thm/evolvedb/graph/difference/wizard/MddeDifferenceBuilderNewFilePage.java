		...
		if (super.validatePage()) {
			...
			if(isCreateModelSelected()) {
				...
				if (extension == null || !MIGRATION_EXTENSIONS.contains(extension)) {
					...
					setErrorMessage(GraphEditorPlugin.INSTANCE.getString(key, new Object[] { FORMATTED_MIGRATION_FILE_EXTENSIONS }));
	...
	protected Collection<String> getEncodings() {
		if (encodings == null) {
			...
			for (StringTokenizer stringTokenizer = new StringTokenizer(
					GraphEditorPlugin.INSTANCE.getString("_UI_XMLEncodingChoices")); stringTokenizer.hasMoreTokens();) {
