 ...
 *
 */
public class ResolvemasterDetailAction extends DelegatingMasterDetailAction {

	private static final String ICON_PATH = "icons/full/obj16/check16.png"; //$NON-NLS-1$
	 ...
	 */
	public ResolvemasterDetailAction(EditingDomain editingDomain) {
		super(editingDomain);
	}
	...
	protected CommandActionHandler createDelegatedAction(EditingDomain editingDomain) {
		return new ResolveAction(editingDomain);
	}

	@Override
	protected boolean isExecuteOnKeyRelease(KeyEvent event) {
		return isActivated(event, SWT.CTRL, 'r');
	}
