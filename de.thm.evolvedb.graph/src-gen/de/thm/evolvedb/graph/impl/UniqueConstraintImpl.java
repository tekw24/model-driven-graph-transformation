 ...
 * </p>
 * <ul>
 *   <li>{@link de.thm.evolvedb.graph.impl.UniqueConstraintImpl#getProperties <em>Properties</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UniqueConstraintImpl extends ConstraintImpl implements UniqueConstraint {
	...
	protected EClass eStaticClass() {
		return GraphPackage.Literals.UNIQUE_CONSTRAINT;
	}
	...
	public EList<Property> getProperties() {
		if (properties == null) {
			properties = new EObjectResolvingEList<Property>(Property.class, this,
					GraphPackage.UNIQUE_CONSTRAINT__PROPERTIES);
		}
		return properties;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case GraphPackage.UNIQUE_CONSTRAINT__PROPERTIES:
