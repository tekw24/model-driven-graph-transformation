...
public class MDDECodeGenerationWizardPage_1 extends WizardPage{
	...
	protected MDDECodeGenerationWizardPage_1(String pageName, String title, ImageDescriptor titleImage, MDDECodeGenerationController controller) {
		super(pageName, title, titleImage);
		this.controller = controller;
		setMessage("This page shows the registered code generators. Every generator has to implement the ISQLGenerator extension point.");
	...
	protected Label createMessageArea(Composite composite) {
		...
		factory.text("The list contains all registered SQL generators. New generators can be added by contributing to the ISQLGenerator extension point.");
...
//		}
		...
		if(newSelection.length == 1) {
			boolean result = controller.setGenerator((String) newSelection[0]);
