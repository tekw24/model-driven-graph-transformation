 ...
 *
 */
public class SemanticChangeSetRendererService implements EMFFormsDIRendererService<VControl> {
	...
	public double isApplicable(VElement vElement, ViewModelContext viewModelContext) {
		...
		if (MigrationPackage.eINSTANCE.getSchemaModificationOperator_SemanticChangeSets().equals(eStructuralFeature)) {
			return 10;
		}
		return NOT_APPLICABLE;
	...
	public Class<? extends AbstractSWTRenderer<VControl>> getRendererClass() {
		return SemanticChangeSetRenderer.class;
	}
