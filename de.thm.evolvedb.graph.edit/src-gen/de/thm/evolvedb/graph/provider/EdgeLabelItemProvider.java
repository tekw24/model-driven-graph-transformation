...
/**
 * This is the item provider adapter for a {@link de.thm.evolvedb.graph.EdgeLabel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EdgeLabelItemProvider extends LabelItemProvider {
	/**
	...
	protected void addEdgesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_EdgeLabel_edges_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_EdgeLabel_edges_feature",
								"_UI_EdgeLabel_type"),
						GraphPackage.Literals.EDGE_LABEL__EDGES, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		String label = ((EdgeLabel) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_EdgeLabel_type")
