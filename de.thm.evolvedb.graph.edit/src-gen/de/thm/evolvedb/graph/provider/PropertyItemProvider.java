...
/**
 * This is the item provider adapter for a {@link de.thm.evolvedb.graph.Property} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PropertyItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Property_name_feature",
								"_UI_Property_type"),
						GraphPackage.Literals.PROPERTY__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GraphPackage.Literals.PROPERTY__VALUE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(GraphPackage.Literals.PROPERTY__VALUE, GraphFactory.eINSTANCE.createUnionType()));
		...
		newChildDescriptors.add(
				createChildParameter(GraphPackage.Literals.PROPERTY__VALUE, GraphFactory.eINSTANCE.createStringType()));
