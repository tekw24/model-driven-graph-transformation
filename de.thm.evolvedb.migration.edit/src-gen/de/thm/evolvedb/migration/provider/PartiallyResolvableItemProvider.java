 ...
 * @generated
 */
public class PartiallyResolvableItemProvider extends SchemaModificationOperatorItemProvider {
	/**
	 ...
	 * @generated
	 */
	public PartiallyResolvableItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PartiallyResolvable_displayName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PartiallyResolvable_displayName_feature", "_UI_PartiallyResolvable_type"),
				 MigrationPackage.Literals.PARTIALLY_RESOLVABLE__DISPLAY_NAME,
				 true,
				 false,
				 false,
	...
	protected void addResolveOptionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PartiallyResolvable_resolveOptions_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PartiallyResolvable_resolveOptions_feature", "_UI_PartiallyResolvable_type"),
				 MigrationPackage.Literals.PARTIALLY_RESOLVABLE__RESOLVE_OPTIONS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This returns PartiallyResolvable.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated NOT
	 */
...
//			getString("_UI_PartiallyResolvable_type") + " " + label;
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PartiallyResolvable.class)) {
