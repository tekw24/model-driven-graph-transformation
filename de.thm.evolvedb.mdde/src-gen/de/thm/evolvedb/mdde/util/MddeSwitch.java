 ...
 * @generated
 */
public class MddeSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case MddePackage.DATABASE_SCHEMA: {
				Database_Schema database_Schema = (Database_Schema)theEObject;
				T result = caseDatabase_Schema(database_Schema);
				if (result == null) result = caseNamedElement(database_Schema);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseDatabase_Schema(Database_Schema object) {
		return null;
	}
