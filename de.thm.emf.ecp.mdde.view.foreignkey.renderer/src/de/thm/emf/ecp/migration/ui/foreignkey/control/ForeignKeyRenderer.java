 ...
 *
 */
public class ForeignKeyRenderer extends LinkControlSWTRenderer {
	...
	public ForeignKeyRenderer(VControl vElement, ViewModelContext viewContext, ReportService reportService,
	...
	protected ReferenceService getReferenceService() {
		...
		return new ForeignKeyReferenceService();
	}
