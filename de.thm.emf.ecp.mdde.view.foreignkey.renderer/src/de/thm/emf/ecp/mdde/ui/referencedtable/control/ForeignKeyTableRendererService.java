 ...
 *
 */
public class ForeignKeyTableRendererService implements EMFFormsDIRendererService<VControl> {
	...
	public double isApplicable(VElement vElement, ViewModelContext viewModelContext) {
		...
		if (MddePackage.eINSTANCE.getForeignKey_ReferencedTable().equals(eStructuralFeature)) {
			return 10;
		}
		return NOT_APPLICABLE;
	...
	public Class<? extends AbstractSWTRenderer<VControl>> getRendererClass() {
		return ForeignKeyTableRenderer.class;
	}
